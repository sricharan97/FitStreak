 ...
 * Use the [GoalSelectionFragment.newInstance] factory method to
...
class GoalSelectionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GoalSelectionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GoalSelectionFragment().apply {
    ...
    private fun navigateToHomeDest() {
        ...
        findNavController().navigate(GoalSelectionFragmentDirections.actionGlobalHomeDest2())
